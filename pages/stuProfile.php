...
$query = "SELECT * FROM stu_info WHERE userid = '".$loginID."'";
              ...
              <div class="col-md-6">
                  <div style="width:600px; margin:0px auto">
                      <form class="" action="" method="post">
                          ...
                          <div class="form-group">
                            <label for="password">Password</label>
                            <?php echo "<input type='text' name='password'  value='".$rows['sex']."' class='form-control' placeholder='12345678D'>" ?>
                          </div>
                          <div class="form-group">
                            <label for="password">Password</label>
                            <?php echo "<input type='text' name='password'  value='".$rows['BOD']."' class='form-control' placeholder='12345678D'>" ?>
                          </div>
                          <div class="form-group">
                            <div class="form-group">
